...
class User(models.Model):
    ...
    mailaddress = models.CharField(verbose_name="メールアドレス", db_column='MailAddress', unique=True, max_length=128)  # Field name made lowercase.
    ...
    admin = models.BooleanField(verbose_name="管理者フラグ", db_column='Admin')  # Field name made lowercase.
    family = models.BooleanField(verbose_name="家族フラグ", db_column='Family')  # Field name made lowercase.
    logindate = models.CharField(verbose_name="ログイン日時", db_column='LoginDate', max_length=10)  # Field name made lowercase.
